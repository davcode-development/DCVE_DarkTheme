...
const patchCharts = function() {
	...
	Ext.chart.theme.Base.prototype.config.axis.defaults.style.strokeStyle = '#222931';
...
function patchGaugeWidget() {
	...
	Proxmox.panel.GaugeWidget.prototype.defaultColor = '#222931';
...
patchTFAEdit();
patchCreateWidget();
console.log('DCVE_DarkTheme :: Patched');
